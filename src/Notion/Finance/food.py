...
class Food(Finance):
    ...
    def sum_price(self, note: str):
        reg_str = "LineMan\(([\d.,\s]*)\), TrueMoney\(([\d.,\s]*)\), TTB\(([\d.,\s]*)\), Other\(([\d.,\s]*)\)"
        match = re.findall(reg_str, note)[0]

        total = {"LineMan": 0.0, "TrueMoney": 0.0, "TTB": 0.0, "Other": 0.0}
                ...
                json={
                    ...
                    "properties": {
                        "Budget Item": {
                            "type": "relation",
                            "relation": [
                                {"id": "0b0ceed0-cfb8-4fbb-a16d-bc62ff7a1a7e"}
                            ],
                            "has_more": False,
                        },
                        "Item": {
                            "type": "select",
                            "select": {
                                "id": "865252b6-c9e2-4c54-86a3-29cc5e516e9f",
                                "name": "🍔 ค่าอาหาร",
                                "color": "brown",
                            },
                        },
